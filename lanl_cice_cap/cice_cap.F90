...
! This will help to determine roughly which fields can be hooked into cice
   ...
   !call dumpCICEInternal(ice_grid_i, internal_slice, "mean_down_sw_vis_dif_flx" , "will provide", swvdf)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "mean_down_sw_ir_dir_flx", "will provide", swidr)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "mean_down_sw_ir_dif_flx", "will provide", swidf)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "mean_down_lw_flx", "will provide", flw)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "mean_prec_rate", "will provide", frain)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "mean_fprec_rate", "will provide", fsnow)
   call dumpCICEInternal(ice_grid_i, internal_slice, "ocn_current_zonal", "will provide", uocn)
   call dumpCICEInternal(ice_grid_i, internal_slice, "ocn_current_merid", "will provide", vocn)
   call dumpCICEInternal(ice_grid_i, internal_slice, "sea_surface_slope_zonal", "will provide", ss_tltx)
   call dumpCICEInternal(ice_grid_i, internal_slice, "sea_surface_slope_merid", "will provide", ss_tlty)
   call dumpCICEInternal(ice_grid_i, internal_slice, "sea_surface_salinity", "will provide", sss)
   call dumpCICEInternal(ice_grid_i, internal_slice, "sea_surface_temperature", "will provide", sst)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "freezing_melting_potential", "will provide", frzmlt)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "xx_inst_frz_mlt_potential", "will provide", frzmlt_init)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "freezing_temp", "will provide", Tf)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "mean_deep_ocean_down_heat_flx", "will provide", qdp)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "mixed_layer_depth", "will provide", hmix)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "xx_daice_da", "will provide", daice_da)

!--------- export fields from Sea Ice -------------

   call dumpCICEInternal(ice_grid_i, internal_slice, "ice_fraction"                     , "will provide", aice)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "inst_ice_vis_dir_albedo"         , "will provide", alvdr)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "inst_ice_ir_dir_albedo"          , "will provide", alidr)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "inst_ice_vis_dif_albedo"         , "will provide", alvdf)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "inst_ice_ir_dif_albedo"          , "will provide", alidf)
   call dumpCICEInternal(ice_grid_i, internal_slice, "stress_on_air_ice_zonal"         , "will provide", strairxT)
   call dumpCICEInternal(ice_grid_i, internal_slice, "stress_on_air_ice_merid"         , "will provide", strairyT)
   call dumpCICEInternal(ice_grid_i, internal_slice, "stress_on_ocn_ice_zonal"         , "will provide", strocnxT)
   call dumpCICEInternal(ice_grid_i, internal_slice, "stress_on_ocn_ice_merid"         , "will provide", strocnyT)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "mean_sw_pen_to_ocn"              , "will provide", fswthru)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "mean_net_sw_vis_dir_flx"         , "will provide", fswthruvdr)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "mean_net_sw_vis_dif_flx"         , "will provide", fswthruvdf)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "mean_net_sw_ir_dir_flx"          , "will provide", fswthruidr)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "mean_net_sw_ir_dif_flx"          , "will provide", fswthruidf)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "mean_up_lw_flx_ice"              , "will provide", flwout)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "mean_sensi_heat_flx_atm_into_ice", "will provide", fsens)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "mean_laten_heat_flx_atm_into_ice", "will provide", flat)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "mean_evap_rate_atm_into_ice"     , "will provide", evap)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "mean_fresh_water_to_ocean_rate"  , "will provide", fresh)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "mean_salt_rate"                  , "will provide", fsalt)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "net_heat_flx_to_ocn"             , "will provide", fhocn)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "mean_ice_volume"                 , "will provide", vice)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "mean_snow_volume"                , "will provide", vsno)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "xx_inst_temp_height2m", "will provide", Tref)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "xx_inst_spec_humid_height2m", "will provide", Qref)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "xx_mean_albedo_vis_dir", "will provide", alvdr_ai)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "xx_mean_albedo_nir_dir", "will provide", alidr_ai)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "xx_mean_albedo_vis_dif", "will provide", alvdf_ai)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "xx_mean_albedo_nir_dif", "will provide", alidf_ai)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "xx_bare_ice_albedo", "will provide", albice)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "xx_snow_albedo", "will provide", albsno)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "xx_melt_pond_albedo", "will provide", albpnd)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "xx_apeff_ai", "will provide", apeff_ai)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "xx_mean_fresh_water_flx_to_ponds", "will provide", fpond)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "xx_strairx_ocn", "will provide", strairx_ocn)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "xx_strairy_ocn", "will provide", strairy_ocn)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "xx_mean_sensi_heat_flx", "will provide", fsens_ocn)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "xx_mean_laten_heat_flx", "will provide", flat_ocn)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "xx_flwout_ocn", "will provide", flwout_ocn)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "xx_evap_ocn", "will provide", evap_ocn)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "xx_albedo_vis_dir", "will provide", alvdr_ocn)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "xx_albedo_nir_dir", "will provide", alidr_ocn)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "xx_albedo_vis_dif", "will provide", alvdf_ocn)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "xx_albedo_nir_dif", "will provide", alidf_ocn)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "xx_2m_atm_ref_temperature", "will provide", Tref_ocn)
   !call dumpCICEInternal(ice_grid_i, internal_slice, "xx_2m_atm_ref_spec_humidity", "will provide", Qref_ocn)
